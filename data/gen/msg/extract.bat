...
for /D %%v in (*) do (
    ...
    %BTOOL% "%%v\menu_dlc01\msg\%%v\GR_MenuText.fmg"
    %BTOOL% "%%v\menu_dlc01\msg\%%v\GR_MenuText_dlc01.fmg"
    mkdir "..\text\%%v" 2>NUL
    echo   Copying...
    ...
    copy /y "%%v\menu_dlc01\msg\%%v\GR_MenuText.txt" "..\text\%%v\" >NUL
    copy /y "%%v\menu_dlc01\msg\%%v\GR_MenuText_dlc01.txt" "..\text\%%v\" >NUL
    echo   Cleaning up...
