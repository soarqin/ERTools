...
WINGETOPT_API extern wchar_t *optarg;        /* pointer to argument of current option  */

extern int getopt(int nargc, wchar_t *const *nargv, const wchar_t *options);
...
extern int getopt_long(int nargc, wchar_t *const *nargv, const wchar_t *options,
                       const struct option *long_options, int *idx);
extern int getopt_long_only(int nargc, wchar_t *const *nargv, const wchar_t *options,
                            const struct option *long_options, int *idx);
/*
